...
/**
 * This is the root path for our restful api service In the web.xml file, we specified that /api/* need to be in the URL to get to this class.
 * 
...
public class V1_status {
	...
	/**
	 * This method will return the version number of the api Note: this is nested one down from the root. You will need to add version into the URL
	 * path.
	 * 
